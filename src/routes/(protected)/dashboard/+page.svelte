		...
		<div class="space-y-4">
			<div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
					...
					<div class="flex items-center gap-2">
						...
						<span class="group relative inline-flex">
							...
							<span
								...
								class="pointer-events-none absolute left-1/2 top-full z-20 mt-2 w-72 -translate-x-1/2 rounded-md border border-amber-200 bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 px-2 py-1.5 text-[11px] leading-relaxed text-amber-900 opacity-0 shadow-md transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
							>
								Now that we've established you have enough to live on we need to ensure all
								of your accounts remain in the black. Stage 2 is about allocating funds to
				...
				{#if plannerStage === 'autofund'}
					...
					{#if plannerFirstShortfall}
						...
						<div class="font-semibold">
							Stage 2: Allocation for {plannerFirstShortfall.targetAccountName} from {plannerFirstShortfall.monthLabel} from which account...
						</div>
				...
				<div class={`mt-3 flex items-center justify-between rounded-lg border px-3 py-2 text-sm ${!stage3Reached ? 'border-slate-200 bg-slate-50 text-slate-500' : 'border-emerald-200 bg-emerald-50 text-emerald-800'}`}>
					<div class="flex items-center gap-2">
						<span class="font-semibold">Stage 3: Wealth</span>
						<span class="group relative inline-flex">
							<button
								type="button"
								class="grid h-4 w-4 place-items-center rounded-full border border-current/30 bg-white/80 text-[10px] leading-none font-bold"
								aria-label="What is Stage 3 wealth?"
							>
								i
							</button>
							<span
								...
								class="pointer-events-none absolute left-1/2 top-full z-20 mt-2 w-72 -translate-x-1/2 rounded-md border border-amber-200 bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 px-2 py-1.5 text-[11px] leading-relaxed text-amber-900 opacity-0 shadow-md transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
							>
								Now that all your accounts are in the black, Stage 3 is about ensuring the amounts in
								each asset & account maintain a good balance between protecting your needs and growing
